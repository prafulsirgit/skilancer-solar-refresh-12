  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 left-10 w-96 h-96 bg-sky/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="container mx-auto px-4 pt-24 relative z-10">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-card/10 backdrop-blur-sm rounded-full border border-card/20 mb-8 animate-fade-in">
            ...
            <span className="text-card/90 text-sm font-medium">8+ Years of Excellence in Solar Technology</span>
          </div>
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-card mb-6 leading-tight animate-slide-up">
            ...
            <span className="text-gradient-solar block mt-2">powered by automation.</span>
          </h1>

          {/* Subheadline */}
          <p className="text-card/80 text-lg md:text-xl max-w-2xl mb-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            Premium automatic dry-cleaning <strong className="text-card">Robotic Solar Panel Cleaning Solutions</strong> for solar power plants, reducing manual effort and operational costs.
          </p>
          ...
          {/* Stats Preview */}
          <div className="flex flex-wrap gap-8 mt-16 pt-8 border-t border-card/20 animate-fade-in" style={{ animationDelay: '0.6s' }}>
            {[
